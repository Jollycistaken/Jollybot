    ...
    execute(message, args) {
        ...
        if (!args.length) {
            ...
            commands.forEach((cmd) => {
                let helpEmbed = new Discord.MessageEmbed()
                    .setTitle('Animals: ')
                    .setDescription('Animal pictures/facts')
                    .setColor(process.colors.bestcolor)
                if (cmd.topic === "animal") {
                    helpEmbed.addField(
            ...
            let helpEmbed = new Discord.MessageEmbed()
                .setColor(process.colors.bestcolor)
                .setTitle('Fun: ')
                .setDescription('Fun commands on this bot')
            commands.forEach((cmd) => {
            ...
            let helpEmbed = new Discord.MessageEmbed()
                .setTitle('Games: ')
                .setDescription('Game specific commands or games in the bot')
                .setColor(process.colors.bestcolor)
            commands.forEach((cmd) => {
                if (cmd.topic === "game") {
                    helpEmbed.addField(
            ...
            let helpEmbed = new Discord.MessageEmbed()
                .setTitle('Images: ')
                .setDescription('Image generators/editors lol')
                .setColor(process.colors.bestcolor)
            commands.forEach((cmd) => {
                if (cmd.topic === "image") {
                    helpEmbed.addField(
            ...
            let helpEmbed = new Discord.MessageEmbed()
                .setTitle('Memes: ')
                .setDescription('Meme sender/maker')
                .setColor(process.colors.bestcolor)
            commands.forEach((cmd) => {
                if (cmd.topic === "meme") {
                    helpEmbed.addField(
            ...
            let helpEmbed = new Discord.MessageEmbed()
                .setTitle('Utilities')
                .setDescription('Useful commands for servers')
                .setColor(process.colors.bestcolor)
            commands.forEach((cmd) => {
